...
const Home = () => {
  ...
  const handleActivityAdded = (newActivity) => {
    // Update the userActivities state with the new activity
    ...
    <main>
      <div className="home-container">
        <Grid container spacing={3}>
          ...
          <Grid item xs={6}>
            {/* Pass userActivities and handleActivityAdded to CreateActivityForm */}
            <CreateActivityForm userActivities={userActivities} onActivityAdded={handleActivityAdded} />
            <br />
            <br />
            <br />
